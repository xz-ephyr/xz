    ...
    <div className="flex flex-col h-screen overflow-hidden bg-background relative">
      ...
      <div className="flex flex-1 min-h-0">
        ...
        >
          ...
          >
            {messages.length > 0 && <div className="h-[8px] bg-background w-full shrink-0" />}
            <div className="w-full mx-auto px-4 pb-24" style={{ maxWidth: 'min(880px, 100%)' }}>
              ...
              {messages.length === 0 && (
                <div className="w-full mt-4 flex flex-col items-center overflow-visible pb-10">
                  <h1 className="text-[38px] font-serif-source mb-[10px] text-card-foreground text-center">
          ...
          {showScrollButton && (
            <div className="shrink-0 flex justify-center w-full mx-auto bg-background relative" style={{ height: 0 }}>
              <button
                onClick={scrollToBottom}
                className="absolute left-1/2 -translate-x-1/2 bottom-8 flex items-center justify-center w-9 h-9 rounded-full bg-muted hover:bg-accent text-foreground transition-all shadow-sm z-10"
          ...
          {messages.length > 0 && (
            <div className="shrink-0 pb-8 w-full mx-auto px-4 bg-background" style={{ maxWidth: 'min(880px, 100%)' }}>
              <ChatInput
                onSend={handleSend}
                isLoading={isLoading}
                onStop={stop}
        ...
        {isPanelOpen && artifacts.length > 0 && (
          ...
          >
            ...
            >
              <div className="w-px h-full bg-border group-hover/divider:bg-muted-foreground/60 group-active/divider:bg-muted-foreground transition-colors" />
            </div>
            {isMobile && (
